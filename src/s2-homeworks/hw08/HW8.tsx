...
const HW8 = () => {
    ...
    const finalPeople = people.map((user: UserType) => <User key={user._id} user={user}/>)

    const sortUp = () => {
        setPeople(
            homeWorkReducer(initialPeople, {type: 'sort-up', payload: 'up'})
    ...
    const sortDown = () => {
        setPeople(
            homeWorkReducer(initialPeople, {type: 'sort-down', payload: 'down'})
